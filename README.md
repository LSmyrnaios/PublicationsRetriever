...
- You can clean up the memory by calling the "***clearBlockingData()***" and/or the "***clearTrackingData()***" method, found in ***[util.url.GenericUtils.java](https://github.com/LSmyrnaios/PublicationsRetriever/blob/7a74ffb7bdade36d6ba94032e730c2bbcb5f7731/src/main/java/eu/openaire/publications_retriever/util/url/GenericUtils.java)***, whenever it is convenient for you. 
