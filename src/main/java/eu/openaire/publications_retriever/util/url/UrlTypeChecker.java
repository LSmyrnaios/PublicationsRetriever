...
public class UrlTypeChecker
{
	...
	public static void setRuntimeInitializedRegexes() {
		URL_DIRECTORY_FILTER =
			Pattern.compile("^https?://.*/(?:(?:(?:(?:discover|profile|user|survey|index|media|theme|product|deposit|default|shop)/" + docOrDatasetNegativeLookAroundPattern	// Avoid blocking these if the url is likely to give a file.
