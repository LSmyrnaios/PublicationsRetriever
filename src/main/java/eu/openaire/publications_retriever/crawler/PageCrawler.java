...
public class PageCrawler
{
	...
	public static final Pattern NON_VALID_DOCUMENT = Pattern.compile(".*(?:[^e]manu[ae]l|(?:\\|\\|" + space + ")?gu[ií](?:de|a)|preview|leaflet|agreement(?!.*thesis" + space + "(?:19|20)[\\d]{2}.*)|accessibility|journal" + space + "catalog|disclose" + space + "file|poli(?:c(?:y|ies)|tika)"	// "policy" can be a lone word or a word after: repository|embargo|privacy|data protection|take down|supplement|access
																		...
																		+ "|data-sharing-guidance|rate(?:" + space + ")?cards|press" + space + "release|liability" + space + "disclaimer|(?:avec|dans)" + space + "(?:ocd|x2)?hal"
																		...
																		+ "|/(?:entry|information|opinion|rapportannuel|accesorestringido|library_recommendation_form|research-article|publerkl[\\w]*|loi_republique_numerique_publis).pdf$).*");	// The plain "research-article.pdf" is the template provided by journals.
