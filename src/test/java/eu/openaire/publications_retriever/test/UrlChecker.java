...
/*			String urlPath = UrlUtils.getPathStr(urlToCheck, null);
			...
			try {
				...
				UrlUtils.logOutputData(null, urlToCheck, null, UrlUtils.unreachableDocOrDatasetUrlIndicator, "Discarded at loading time, due to connectivity problems.", null, true, "true", "true", "false", "false", "false");
			}
		}
